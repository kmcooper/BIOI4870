...
#Source: This code was derived from itsnavneetk's Github repo
# 	 https://github.com/itsnavneetk/booleanRetrieval
#Source for corpus (shortstories folder) is http://textfiles.com

# Declare variables, including the map where dictionary 
# terms will be stored as keys and 
# value will be posting list with position in the file
dictionary = {}
matrix = {}
docIdMap = {}
